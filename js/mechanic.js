...
function initMap(position){
	...
	// API_KEY: AIzaSyB24Tw0mMvY3QYI-ofmVorm-WHhmFSgy2E
    let url_str = 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+lati+','+lngi+'&key=AIzaSyB24Tw0mMvY3QYI-ofmVorm-WHhmFSgy2E'
    ...
    google.maps.event.addListener(marker, 'dragend', function(evt){
    	...
    	let url_str = 'https://maps.googleapis.com/maps/api/geocode/json?latlng='+evt.latLng.lat().toFixed(3)+','+evt.latLng.lng().toFixed(3)+'&key=AIzaSyB24Tw0mMvY3QYI-ofmVorm-WHhmFSgy2E'
    	$.getJSON(url_str, function(data) {
        	console.log(data);
...
function destination(){
	...
	var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 18,
          center: {lat: 24.916667, lng: 67.083333}
        });
